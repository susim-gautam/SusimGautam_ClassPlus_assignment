...
router.post('/seed', async (req, res) => {
  const templates = [
    { title: 'Birthday Bash', category: 'Birthday', imageUrl: 'https://images.unsplash.com/photo-1530103862676-fa8c91bbe34b?auto=format&fit=crop&q=80&w=800', isPremium: false },
    ...
    { title: 'Party Time', category: 'Birthday', imageUrl: 'https://images.unsplash.com/photo-1464349172961-60a659580c33?auto=format&fit=crop&q=80&w=800', isPremium: true }
  ];
